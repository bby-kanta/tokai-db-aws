...
また、東海オンエアには「***十字架***」と呼ばれる制度があります。これは東海オンエアのメンバーが、動画内での対決に負けたり、ルーレットやじゃんけんなどで指名されたりしたときに、一定期間背負い続ける罰ゲームのことなのですが、これだけでは分からないと思うので、参考までに、、、

なんと運悪く十字架を課せられると、このような格好を1ヶ月いかなるときも（動画撮影時、プライベートで遊ぶ時、デートのときも）しなければなりません。こんな面白い十字架がたくさん存在します！！
もちろん視聴者はこの十字架が大好きですので、十字架から動画を見つけたいときが多々あります。
